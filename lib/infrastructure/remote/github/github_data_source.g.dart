...
class _GithubDataSource implements GithubDataSource {
  ...
  Future<SearchRepositoriesResult> searchRepositories(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<SearchRepositoriesResult>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = SearchRepositoriesResult.fromJson(_result.data!);
    return value;
  }
  ...
  Future<GetRepositoryContentResult> getRepositoryContent(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<GetRepositoryContentResult>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = GetRepositoryContentResult.fromJson(_result.data!);
    return value;
  }
